...
const BOSS_LIST = [
  ...
  { name: 'TzTok-Jad',               keywords: ['jad','tztok-jad','tztokjad','fight caves','fc'] },
  { name: 'The Gauntlet',            keywords: ['gauntlet','the gauntlet','crystalline'] },
  { name: 'The Corrupted Gauntlet',  keywords: ['corrupted gauntlet','cg'] },
  { name: 'Chaos Fanatic',           keywords: ['chaos fanatic'] },
  { name: 'Crazy Archaeologist',     keywords: ['crazy archaeologist','crazy arch'] },
  { name: 'Deranged Archaeologist',  keywords: ['deranged archaeologist','deranged arch'] },
  { name: 'Mimic',                   keywords: ['mimic'] },
  { name: 'Scurrius',                keywords: ['scurrius'] },
  { name: 'Skotizo',                 keywords: ['skotizo'] },
  { name: 'Yama',                    keywords: ['yama'] },
  { name: 'Brutus',                  keywords: ['brutus'] },
  { name: 'Lunar Chests',            keywords: ['lunar chests','lunar'] },
  { name: 'Mad Angel',               keywords: ['mad angel'] },
  { name: 'Shellbane Gryphon',       keywords: ['shellbane gryphon','gryphon'] },
  { name: 'Doom of Mokhaiotl',       keywords: ['doom of mokhaiotl','doom','mokhaiotl'] },
  { name: "Phosani's Nightmare",     keywords: ['phosani','phosanis nightmare',"phosani's nightmare"] },
  { name: 'Theatre of Blood (Hard Mode)', keywords: ['tob hard mode','hmt','theatre of blood hard mode'] },
  { name: 'Tombs of Amascut (Expert Mode)', keywords: ['toa expert','tombs of amascut expert'] },
  { name: 'Chambers of Xeric (Challenge Mode)', keywords: ['cox cm','chambers of xeric challenge mode','challenge mode'] },
];
